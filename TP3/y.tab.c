...
{
       9,     0,    -1,    10,    12,    -1,    10,     3,    11,    -1,
      -1,     5,    11,    -1,     5,    -1,    12,     4,    13,    -1,
      -1,     5,    14,    -1,    13,     5,    14,    -1,     6,     7,
      14,    -1,     6,    -1
};
...
#line 29 "thesaurus.y"
  ...
  case 3:
#line 32 "thesaurus.y"
    {addOption((yyvsp[(2) - (3)].string), rel4Opts), rel4Opts = NULL, printf("%s - %s\n", (yyvsp[(1) - (3)].string), (yyvsp[(2) - (3)].string));}
    break;
...
#line 33 "thesaurus.y"
  ...
  case 5:
#line 36 "thesaurus.y"
    {rel4Opts = g_list_append(rel4Opts, (yyvsp[(1) - (2)].string)); asprintf(&(yyval.string), "%s%s", (yyvsp[(1) - (2)].string), (yyvsp[(2) - (2)].string));}
    break;

  case 6:
#line 37 "thesaurus.y"
    {rel4Opts = g_list_append(rel4Opts, (yyvsp[(1) - (1)].string));}
    break;

  case 7:
#line 41 "thesaurus.y"
    {
																		 searchTerms((yyvsp[(2) - (3)].string),relations);
...
#line 54 "thesaurus.y"
  ...
  case 11:
#line 60 "thesaurus.y"
    { c = newConceito((yyvsp[(1) - (3)].string),NULL); addConceito(c);
  ...
  case 12:
#line 63 "thesaurus.y"
    { c = newConceito((yyvsp[(1) - (1)].string),NULL); addConceito(c);
